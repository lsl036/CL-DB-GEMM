// GEMM kernel， 没有进行预处理，需要相应的参数是 M、N、K的倍数限制，用于实验Bayesian的调优性能。
...
// =======================================================
// CLBLAST kernel for GEMM
// =======================================================
// Main body of the matrix-multiplication algorithm. It calls various (inlined) functions.
INLINE_FUNC void XgemmBody(const int kSizeM, const int kSizeN, const int kSizeK, const __global realM* restrict agm, const __global realN* restrict bgm, __global realM* cgm, const real alpha, const real beta
#if SA == 1 && SB == 1
...
// =======================================================
//   double-buffer kernel of MYGEMM
// =======================================================
