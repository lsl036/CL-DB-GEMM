...
//My Modified GEMM
CLBlastStatusCode CLBlastMySgemm(const CLBlastLayout layout, const CLBlastTranspose a_transpose, const CLBlastTranspose b_transpose,
  ...
  try {
    return static_cast<CLBlastStatusCode>(
      clblast::MyGemm(static_cast<clblast::Layout>(layout),
                    static_cast<clblast::Transpose>(a_transpose),
