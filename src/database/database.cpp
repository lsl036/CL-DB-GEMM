...
Database::Database(const Device &device, const std::string &kernel_name,
  ...
  if (database.size() == 0) {
    database = std::vector<database::DatabaseEntry>{
        ...
        database::MyXgemmHalf, database::MyXgemmSingle, database::MyXgemmDouble, database::MyXgemmComplexSingle,
        database::MyXgemmComplexDouble,
        ...
        database::MyXgemmDirectHalf, database::MyXgemmDirectSingle, database::MyXgemmDirectDouble, database::MyXgemmDirectComplexSingle, database::MyXgemmDirectComplexDouble,
        ...
        database::MyGemmRoutineHalf, database::MyGemmRoutineSingle, database::MyGemmRoutineDouble, database::MyGemmRoutineComplexSingle, database::MyGemmRoutineComplexDouble,
