...
namespace clblast {
namespace database {
// Params{ 0, 1, 16, 2, 32, 16, 128, 16, 16, 128, 0, 0, 1, 0, 4, 8 }
const DatabaseEntry MyXgemmSingle = {
  "MyXgemm", Precision::kSingle, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
          ...
          // { kDeviceNameDefault                                        , Params{ 0, 16, 16, 32, 8, 8, 8, 8, 2, 2, 1, 0, 0, 1, 1, 1 } },
        } },
        { "Fiji", {
        ...
        { "default", {
          ...
          // RX550 默认是这个参数: 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4 
          { Name{"AMD Radeon Pro 580 Compute Engine                 "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 16, 2, 16, 8, 64, 8, 8, 32, 1, 1, 1, 0, 4, 4 } },
          // { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 0, 0, 1, 0, 8, 8 } },
          // error -11
          // { kDeviceNameDefault                                        , Params{ 0, 16, 16, 32, 8, 8, 8, 8, 2, 2, 1, 0, 0, 1, 1, 1 } },
          // { kDeviceNameDefault                                        , Params{ 0, 16, 16, 32, 8, 16, 8, 16, 2, 1, 1, 0, 0, 1, 1, 1 } },
        } },
        { "gfx1030", {
    ...
    { // Jingjia Micro GPUs
      kDeviceTypeGPU, "Jingjia Micro", {
        { "default", {
          ...
          { Name{"Jingjia OpenCL Device JM9230.6304.0130            "}, Params{ 0, 1, 8, 4, 16, 16, 128, 16, 16, 128, 1, 1, 1, 1, 4, 4 } }, // change VMN: 8 --> 4 STRN: 0 --> 1
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "SM8.0", {
          { Name{"NVIDIA A100-PCIE-40GB                             "}, Params{ 0, 1, 16, 2, 8, 8, 32, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
