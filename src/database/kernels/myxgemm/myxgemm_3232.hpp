...
const DatabaseEntry MyXgemmComplexSingle = {
  "MyXgemm", Precision::kComplexSingle, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
    ...
    { // Jingjia Micro GPUs
      kDeviceTypeGPU, "Jingjia Micro", {
        { "default", {
          { Name{"Jingjia OpenCL Device JM9200.6304.0130            "}, Params{ 1, 2, 1, 1, 4, 4, 16, 8, 8, 32, 0, 0, 0, 0, 2, 2 } },
          { Name{"Jingjia OpenCL Device JM9230.6304.0130            "}, Params{ 1, 2, 1, 1, 16, 16, 64, 8, 8, 32, 0, 0, 0, 0, 1, 1 } },
          { kDeviceNameDefault                                        , Params{ 1, 2, 1, 1, 4, 4, 16, 4, 4, 16, 0, 0, 0, 0, 2, 2 } },
        } },
      }
    },
    { // NVIDIA GPUs
