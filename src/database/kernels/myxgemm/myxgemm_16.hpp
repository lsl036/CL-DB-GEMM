...
const DatabaseEntry MyXgemmHalf = {
  "MyXgemm", Precision::kHalf, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
    ...
    { // Jingjia Micro GPUs
      kDeviceTypeGPU, "Jingjia Micro", {
        { "default", {
          ...
          { Name{"Jingjia OpenCL Device JM9230.6304.0130            "}, Params{ 0, 1, 32, 2, 16, 16, 128, 8, 16, 128, 1, 1, 0, 1, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 128, 8, 16, 128, 1, 1, 0, 1, 4, 4 } },
        } },
      }
    },
    { // QUALCOMM GPUs
