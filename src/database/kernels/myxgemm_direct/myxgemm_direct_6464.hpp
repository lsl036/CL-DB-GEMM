...
const DatabaseEntry MyXgemmDirectComplexDouble = {
  "MyXgemmDirect", Precision::kComplexDouble, {"KWID", "MDIMAD", "MDIMCD", "NDIMBD", "NDIMCD", "PADA", "PADB", "VWMD", "VWND", "WGD"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
        ...
        { "gfx1030", {
          ...
          { kDeviceNameDefault                                        , Params{ 16, 8, 16, 8, 8, 0, 0, 1, 2, 16, 0, 0, 0, 0, 0, 0 } },
        } },
        { "gfx1034", {
