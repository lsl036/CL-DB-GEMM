...
const DatabaseEntry MyXgemmDirectComplexSingle = {
  "MyXgemmDirect", Precision::kComplexSingle, {"KWID", "MDIMAD", "MDIMCD", "NDIMBD", "NDIMCD", "PADA", "PADB", "VWMD", "VWND", "WGD"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Fiji", {
    ...
    { // Jingjia Micro GPUs
      kDeviceTypeGPU, "Jingjia Micro", {
        { "default", {
          { Name{"Jingjia OpenCL Device JM9200.6304.0130            "}, Params{ 2, 32, 32, 16, 16, 1, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0 } },
          { Name{"Jingjia OpenCL Device JM9230.6304.0130            "}, Params{ 2, 16, 16, 32, 32, 1, 1, 2, 1, 32, 0, 0, 0, 0, 0, 0 } },
          { kDeviceNameDefault                                        , Params{ 2, 32, 32, 16, 16, 1, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0 } },
        } },
      }
    },
    { // NVIDIA GPUs
