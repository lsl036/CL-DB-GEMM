...
const std::vector<std::string> Routine::routines_mygemm = {"MYGEMM", "HEMM", "SYMM", "TRMM"};
...
Routine::Routine(Queue &queue, EventPointer event, const std::string &name,
    ...
    routine_name_(name),              // 自己修改的传入 "MyGEMM"
    kernel_names_(kernel_names), //{"Copy","Pad","Transpose","Padtranspose","MyXgemm","MyXgemmDirect","MyGemmRoutine"}
    queue_(queue),
    event_(event),
