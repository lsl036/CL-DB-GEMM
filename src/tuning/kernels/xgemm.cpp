...
int main(int argc, char *argv[]) {
  try {
    printf("* V=2 (2/4) Tuning main GEMM kernel (GEMMK == 0) for random parameters out of larger set\n\n");
    StartVariation<2>(argc, argv);

    printf("* V=1 (1/4) Tuning main GEMM kernel (GEMMK == 0) for fixed set of parameters\n\n");
