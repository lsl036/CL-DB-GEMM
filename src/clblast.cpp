...
// My GEMM implementation: SGEMM/DGEMM/CGEMM/ZGEMM/HGEMM
template <typename T>
StatusCode MyGemm(const Layout layout, const Transpose a_transpose, const Transpose b_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = MyXgemm<T>(queue_cpp, event);
    ...
    routine.DoMyGemm(layout, a_transpose, b_transpose,
                   m, n, k,
                   alpha,
                   Buffer<T>(a_buffer), a_offset, a_ld,
...
template StatusCode PUBLIC_API MyGemm<float>(const Layout, const Transpose, const Transpose,
...
// My GEMM tempbuffer size
template <typename T>
StatusCode MyGemmTempBufferSize(const Layout layout, const Transpose a_transpose, const Transpose b_transpose,
                              const size_t m, const size_t n, const size_t k,
                              const size_t a_offset, const size_t a_ld,
                              const size_t b_offset, const size_t b_ld,
                              const size_t c_offset, const size_t c_ld,
  ...
  try {
    ...
    const auto queue_cpp = Queue(*queue);
    const auto device = queue_cpp.GetDevice();
    const auto kernel_names = std::vector<std::string>{"MyXgemm", "MyGemmRoutine"};
    Databases db(kernel_names);
    Routine::InitDatabase(device, kernel_names, PrecisionValue<T>(), {}, db);
...
template StatusCode PUBLIC_API MyGemmTempBufferSize<float>(const Layout, const Transpose, const Transpose,
                                                         const size_t, const size_t, const size_t,
                                                         const size_t, const size_t, const size_t, const size_t,
                                                         const size_t, const size_t, cl_command_queue*, size_t&);
